...
import org.hamcrest.Matchers;import org.hamcrest.core.Is;
...
public class TestRequestAPI {
	...
	public void getListSingleUsers() {
		...
		.then()
			.log().all()
			.spec(this.createResSpec(HttpStatus.SC_OK))
	...
	public void getUserNotFound() {
		...
		.when()
			...
			.then()
			.log().all()
			.spec(this.createResSpec(HttpStatus.SC_NOT_FOUND))
	...
	public void deleteUser() {
		...
		.when()
			.delete("users/2")
		.then()
		.spec(this.createResSpec(HttpStatus.SC_NO_CONTENT))
		;
	}
